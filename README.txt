...
--> Instrucciones para el uso del programa:
    ...
    --> Para la ejecución del programa no incluimos un archivo make debido a la naturaleza simple de Python, para ver los resultados basta con correr el archivo "EntregaFinal.py" (usar comando
python3 EntregaFinal.py ) donde este tiene incluido el archivo "flujo_datos.py" para obtener los valores de las cajas, al iniciar EntregaFinal se mostraran todos los valores necesarios y se le 
